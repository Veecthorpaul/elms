...
?>
							 ...
							 <div class="icon">
            <a href="manageemployee.php" class="small-box-footer" style="margin-left: 20px">More info <i class="fa fa-arrow-circle-right"></i></a> </div>
...
?>                            
							 ...
							 <div class="icon">
            <a href="managedepartments.php" class="small-box-footer" style="margin-left: 20px">More info <i class="fa fa-arrow-circle-right"></i></a> </div>
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                <span class="card-title">Total Leave Type</span>
                                    <?php
...
?>   
							...
							<div class="icon">
            <a href="managecontact.php" class="small-box-footer" style="margin-left: 20px">More info <i class="fa fa-arrow-circle-right"></i></a> </div>
                            <div id="sparkline-line"></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card">
                            <div class="card-content">
                                ...
                                <span class="card-title">Total Designations</span>
                                <span class="stats-counter">
<?php
...
?>
                                    ...
                                    <span class="counter"><?php echo htmlentities($desgcount);?></span></span>
                            </div>
							 <div class="icon">
            <a href="managedesignation.php" class="small-box-footer" style="margin-left: 20px">More info <i class="fa fa-arrow-circle-right"></i></a> </div>
                            <div id="sparkline-bar"></div>
                        </div>
                    </div>
                        <div class="col s12 m12 l4">
    ...
    <?php
$sql = "SELECT id from tblcompany";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$comcount=$query->rowCount();
?>                            
                                <span class="stats-counter"><span class="counter"><?php echo htmlentities($comcount);?></span></span>
                            </div>
							 <div class="icon">
            <a href="managecompany.php" class="small-box-footer" style="margin-left: 20px">More info <i class="fa fa-arrow-circle-right"></i></a> </div>
                            <div id="sparkline-line"></div>
                        </div>
                    </div>
                    <div class="col s12 m12 l4">
